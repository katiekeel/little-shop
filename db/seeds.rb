...
joel = Item.create!(title: "The Joel Special", description: "A gilt-edged, framed photo of Frodo", price: 0.01, image_path: "https://vignette2.wikia.nocookie.net/lotr/images/5/54/Untitledjk.png")
...
pure_evil.items << [palantir, ring, cloak, mud, joel]
